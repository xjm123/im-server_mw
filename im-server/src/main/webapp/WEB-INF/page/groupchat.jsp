  ...
  var showmsg;
	...
	layui.use(['layer',  'jquery'], function(){
      ...
      var sendMsg=function(msg){ 
      	...
      	//   var content = new proto.ImMessageBody();
          //
           // message.setMsgtype(4);
           // message.setCmd(5);
           // message.setGroupid(groupid);//系统用户组0
           // message.setToken(currentsession);
           // message.setSender(currentsession);
           // content.setContent(msg);
           // content.setType(0)
           // message.setContent(content.serializeBinary())
          var json = "{\"msgtype\":4,\"cmd\":5,\"groupId\":\"0\",\"sender\":\""+currentsession+"\",\"token\":\""+currentsession+"\",\"messageBody\":{\"title\":\"123\",\"type\":\"0\",\"content\":\""+msg+"\"}}";
      ...
      showmsg = function(data){
          ...
          var msg = JSON.parse(event.data);
			...
			var  msgbody = proto.ImMessageBody.deserializeBinary(msgmodel.getContent());
  ...
  var initEventHandle = function () {   
              ...
              // alert(event.data);
          	  ...
          	  //      var msg =  proto.Model.deserializeBinary(event.data);      //如果后端发送的是二进制帧（protobuf）会收到前面定义的类型
          	       //心跳消息
			  		// var msg = event.data;
			  		var msg = JSON.parse(event.data);
              		// reMsg(msg.sender,msg.timeStamp,msg.messageBody.content);
          	       if(msg.cmd==2){
          	    	   //发送心跳回应
          ...
          socket.onopen = function(event) {
        	   ...
        	   var browser=BrowserUtil.info();
	   	     ...
	   	     //   message.setDeviceid("")
	   	     //   message.setCmd(1);
	   	     //   message.setGroupid(groupid);//向系统分组
	   	     //   message.setSender(currentsession);
              ...
              var json = "{\"msgtype\":1,\"cmd\":1,\"groupId\":\"0\",\"version\":\"1.0\",\"flag\":\"1\",\"platform\":\""+browser.name+"\",\"platformVersion\":\""+browser.version
				  +"\",\"token\":\""+currentsession+"\",\"sender\":\""+currentsession+"\"}";
               socket.send(json);
          };
          //连接关闭
    ...
    createWebSocket(websocketurl,initEventHandle);  
	 ...
	 $("#winsend").on("click",function(){
    	  ...
    	  if(msg.length>0){
    		  if (!window.WebSocket) {
    			  // Imwebserver.sendGroupMsg(groupid,msg);//浏览器不支持webscoket
    	      }else{
