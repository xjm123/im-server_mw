...
public class Session   implements Serializable{
	...
	private String user_id;//session绑定的用户账号(待观察)
...
//			try{
//				ImMessage  msgModel = (ImMessage)msg;
//				ImMessageBody  content = msgModel.getMessageBody();
...
//		}
	...
	public String toString() {
		return "Session [dwrsession= , nid=" + nid
				+ ", source=" + source + ", deviceId=" + deviceId + ", host="
				+ host + ", user_id=" + user_id + ", account=" + account
				+ ", platform=" + platform + ", platformVersion="
				+ platformVersion + ", appKey=" + appKey + ", bindTime="
				+ bindTime + ", updateTime=" + updateTime + ", sign=" + sign
